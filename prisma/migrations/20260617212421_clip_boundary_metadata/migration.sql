...
INSERT INTO "new_ClipCandidate" ("caption", "clipType", "contextWarning", "createdAt", "durationSeconds", "endTimeSeconds", "exportPath", "hashtags", "hook", "id", "reasonSelected", "riskLevel", "riskReasons", "score", "sermonId", "srtPath", "startTimeSeconds", "status", "subtitlesBurned", "subtitlesGenerated", "title", "transcriptText", "updatedAt") SELECT "caption", "clipType", "contextWarning", "createdAt", "durationSeconds", "endTimeSeconds", "exportPath", "hashtags", "hook", "id", "reasonSelected", "riskLevel", "riskReasons", "score", "sermonId", "srtPath", "startTimeSeconds", "status", "subtitlesBurned", "subtitlesGenerated", "title", "transcriptText", "updatedAt" FROM "ClipCandidate";
