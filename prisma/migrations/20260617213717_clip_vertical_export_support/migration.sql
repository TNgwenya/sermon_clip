...
INSERT INTO "new_ClipCandidate" ("adjustedEndTimeSeconds", "adjustedStartTimeSeconds", "boundaryAdjustmentReason", "boundaryQuality", "caption", "clipType", "contextWarning", "createdAt", "durationSeconds", "endTimeSeconds", "exportPath", "hashtags", "hook", "id", "originalEndTimeSeconds", "originalStartTimeSeconds", "reasonSelected", "renderError", "renderStatus", "renderedAt", "renderedDurationSeconds", "renderedFilePath", "renderedSizeBytes", "riskLevel", "riskReasons", "score", "sermonId", "srtPath", "startTimeSeconds", "status", "subtitlesBurned", "subtitlesGenerated", "title", "transcriptText", "updatedAt") SELECT "adjustedEndTimeSeconds", "adjustedStartTimeSeconds", "boundaryAdjustmentReason", "boundaryQuality", "caption", "clipType", "contextWarning", "createdAt", "durationSeconds", "endTimeSeconds", "exportPath", "hashtags", "hook", "id", "originalEndTimeSeconds", "originalStartTimeSeconds", "reasonSelected", "renderError", "renderStatus", "renderedAt", "renderedDurationSeconds", "renderedFilePath", "renderedSizeBytes", "riskLevel", "riskReasons", "score", "sermonId", "srtPath", "startTimeSeconds", "status", "subtitlesBurned", "subtitlesGenerated", "title", "transcriptText", "updatedAt" FROM "ClipCandidate";
